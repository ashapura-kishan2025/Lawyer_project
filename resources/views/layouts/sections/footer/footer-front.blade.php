...
<footer class="landing-footer bg-body footer-text">
    <div class="footer-top position-relative overflow-hidden z-1">
        <img src="{{ asset('public/assets/img/front-pages/backgrounds/footer-bg-' . $configData['style'] . '.png') }}"
            ...
            <div class="row gx-0 gy-6 g-lg-10">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <a href="javascript:void(0);" class="d-block mb-4"><img
                            src="{{ asset('public/assets/img/front-pages/landing-page/apple-icon.png') }}"
                            alt="apple icon" /></a>
                    <a href="javascript:void(0);" class="d-block"><img
                            src="{{ asset('public/assets/img/front-pages/landing-page/google-play-icon.png') }}"
        ...
        <div
            ...
            <div>
                <a href="{{ config('variables.githubUrl') }}" class="me-3" target="_blank">
                    <img src="{{ asset('public/assets/img/front-pages/icons/github.svg') }}" alt="github icon" />
                </a>
                <a href="{{ config('variables.facebookUrl') }}" class="me-3" target="_blank">
                    <img src="{{ asset('public/assets/img/front-pages/icons/facebook.svg') }}" alt="facebook icon" />
                </a>
                <a href="{{ config('variables.twitterUrl') }}" class="me-3" target="_blank">
                    <img src="{{ asset('public/assets/img/front-pages/icons/twitter.svg') }}" alt="twitter icon" />
                </a>
                <a href="{{ config('variables.instagramUrl') }}" target="_blank">
                    <img src="{{ asset('public/assets/img/front-pages/icons/instagram.svg') }}" alt="google icon" />
                </a>
            </div>
        </div>
    </div>
