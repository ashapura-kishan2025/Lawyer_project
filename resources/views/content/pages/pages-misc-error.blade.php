...
@section('content')
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <div class="mt-4">
                <img src="{{ asset('public/assets/img/illustrations/page-misc-error.png') }}" alt="page-misc-error"
                    width="225" class="img-fluid">
            </div>
        </div>
    </div>
    <div class="container-fluid misc-bg-wrapper">
        <img src="{{ asset('public/assets/img/illustrations/bg-shape-image-' . $configData['style'] . '.png') }}"
